...
class Items:
    def __init__(self, main_ui):
        ...
        self.screen_labelframe = ttk.LabelFrame(self.main_ui.master, text="Screen Controls")
        ...
        self.button_init_ml = ttk.Button(self.screen_labelframe, text="ML Generation",
        ...
        self.turtles_labelframe = ttk.LabelFrame(self.main_ui.master, text="turtles")
        ...
        self.branch_button = ttk.Button(self.branch_labelframe, command=self.main_ui.add_branch)
        ...
        self.fibo_button = ttk.Button(self.fibo_labelframe, command=self.main_ui.add_fibonacci)
        ...
        self.honey_button = ttk.Button(self.honey_labelframe, command=self.main_ui.add_honeycomb)
        ...
        self.h_button = ttk.Button(self.htree_labelframe, command=self.main_ui.add_htree)
        ...
        self.koch_button = ttk.Button(self.koch_labelframe, command=self.main_ui.add_koch)
        ...
        self.carp_button = ttk.Button(self.carp_labelframe, command=self.main_ui.add_scarpet)
        ...
        self.tri_button = ttk.Button(self.tri_labelframe, command=self.main_ui.add_striangle)
        ...
        self.snow_button = ttk.Button(self.snow_labelframe, command=self.main_ui.add_snowflake)
        ...
        self.button_star = ttk.Button(self.star_labelframe, command=self.main_ui.add_star)
        ...
        self.turtle_config_labelframe = ttk.LabelFrame(self.main_ui.master, text="Canvas Config")
        self.turtle_config_labelframe.pack(side=self.items_side, fill="both", expand="yes")

        self.button_queue = ttk.Button(self.turtle_config_labelframe, command=self.main_ui.queue_setter)
        self.button_queue.pack(side=self.subitems_side)

        self.button_rand = ttk.Button(self.turtle_config_labelframe, command=self.main_ui.random_position_setter)
        self.button_rand.pack(side=self.subitems_side)

        self.button_live = ttk.Button(self.turtle_config_labelframe, command=self.main_ui.live_drawing_setter)
        ...
        self.button_random_bg = ttk.Button(self.turtle_config_labelframe, text="Random Background",
                                           command=self.main_ui.random_background)
        ...
        self.theme_frame = ttk.LabelFrame(self.main_ui.master, text='GUI Theme')
        self.theme_frame.pack(side=self.items_side, expand="yes")

        self.theme_labelframe = ttk.LabelFrame(self.main_ui.master, text="GUI Theme")
        self.theme_labelframe.pack(side=self.subitems_side, fill="both", expand="yes")

        self.theme_options = []

        for theme_name in self.main_ui.style.theme_names():
        ...
        self.theme_apply_button = ttk.Button(self.theme_labelframe, text="Apply", command=self.main_ui.change_theme)
        self.theme_apply_button.pack(side=self.subitems_side)

        self.button_exit = ttk.Button(self.main_ui.master, text="Exit", command=self.main_ui.exit)
